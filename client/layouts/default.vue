...
export default {
  ...
  methods: {
    goWeb(target) {
      switch (target) {
        case "sina":
          window.open("http://weibo.com/u/3959538653");
          break;
        case "github":
          window.open("https://github.com/pkjy");
          break;
        case "csdn":
          window.open("http://blog.csdn.net/a214161398a");
          break;
      }
    }
  }
...
.menu .menu-line-1-click,
.menu .menu-line-2-click,
.menu .menu-line-3-click {
  transition: all 0.5s;
}
