  ...
  <div style="padding:20px;">
    <example-card>
      ...
      <template slot="content">
        ...
        <el-button class="m-l_2"
                   type="primary"
                   @click="execCopy(input)">复制</el-button>
      </template>
      <template slot="desc">
    ...
    <example-card>
      ...
      <template slot="content">
        <el-form :model="loginValidateForm"
                 label-position="top"
          ...
          <el-form-item>
            <el-button type="primary"
                       style="width: 100%;"
                       @click="submitLogForm('loginValidateForm')">立即校验</el-button>
          </el-form-item>
        </el-form>
      </template>
      <template slot="desc">
    ...
    <example-card>
      ...
      <template slot="content">
        ...
        <el-input type="text"
                  v-model="fileName"
                  style="width:150px;"></el-input><br>
        <el-button type="primary"
                   style="width:150px;margin:10px auto 0;"
                   @click="downloadCanvas">下载</el-button>
      </template>
      <template slot="desc">
    ...
    <example-card>
      ...
      <template slot="content">
        <el-date-picker v-model="search"
                        ...
                        size="small"
                        @change="getLendingOrderListAction">
        </el-date-picker>
        <el-button @click="mixinSelectDateRange(0,getLendingOrderListAction)"
                   size="small"
                   class="m-l_2">今日</el-button>
        <el-button @click="mixinSelectDateRange(1,getLendingOrderListAction)"
                   size="small">昨日</el-button>
        <el-button @click="mixinSelectDateRange(2,getLendingOrderListAction)"
                   size="small">最近7天</el-button>
        <el-button @click="mixinSelectDateRange(3,getLendingOrderListAction)"
                   size="small">最近30天</el-button>
      </template>
      <template slot="desc">
