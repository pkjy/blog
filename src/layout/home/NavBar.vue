<template>
  <div class="relative">
    <div v-if="hideHeader"
         class="wpb_row full-width-section "
         style="position: relative;padding: 100px 90px 255px;margin-left: -90px;visibility: visible;"
         data-top-percent="12%"
...
.using-image {
  background: url("https://funsonic.oss-cn-hangzhou.aliyuncs.com/cool-wallpaper-3-min.jpg"),
