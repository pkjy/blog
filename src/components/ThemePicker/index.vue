...
import * as  packageJson from 'element-plus/package.json';
const version = packageJson.version // element-ui version from node_modules
...
export default defineComponent({
  ...
  watch: {
    ...
    theme: async function (value: string) {
      if (!value) return
